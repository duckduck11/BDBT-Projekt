...
public class AppController implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/admin/ogrody_botaniczne").setViewName("admin/ogrody_botaniczne");
        registry.addViewController("/user/ogrody_botaniczne").setViewName("user/ogrody_botaniczne");
        ...
        registry.addViewController("/admin/ogrody").setViewName("admin/ogrody");
        registry.addViewController("/user/ogrody").setViewName("user/ogrody");
    ...
    @RequestMapping(value = {"/admin/ogrody"})
    public String showOgrodyAdmin(Model model) {
        List<Ogrody> listOgrody = ogrodyDAO.list();
        model.addAttribute("ogrodyList", listOgrody);
        return "admin/ogrody";
    }

    @RequestMapping(value = {"/user/ogrody"})
    public String showOgrodyUser(Model model) {
        List<Ogrody> listOgrody = ogrodyDAO.list();
        model.addAttribute("ogrodyList", listOgrody);
        return "user/ogrody";
    }
    ...
    @RequestMapping(value = {"/admin/ogrody_botaniczne"})
    public String showOgrodyBotaniczneAdmin(Model model) {
        ...
        return "admin/ogrody_botaniczne";
    }

    @RequestMapping(value = {"/user/ogrody_botaniczne"})
    public String showOgrodyBotaniczneUser(Model model) {
        List<OgrodyBotaniczne> ogrodyBotaniczneList = ogrodyBotaniczneDAO.list();
        model.addAttribute("ogrodyBotaniczneList", ogrodyBotaniczneList);
        return "user/ogrody_botaniczne";
    }
    ...
    @Controller
    public class ogrodyBotController {
        @RequestMapping("/ogrody_botaniczne")
        public String defaultAfterLogin
                (HttpServletRequest request) {
            if (request.isUserInRole("ADMIN")) {
                return "redirect:/admin/ogrody_botaniczne";
            } else if (request.isUserInRole("USER")) {
                return "redirect:/user/ogrody_botaniczne";
            } else {
                return "redirect:";
            }
        }
    ...
    @Controller
    public class ogrodyController {
        @RequestMapping("/ogrody")
        public String defaultAfterLogin
                (HttpServletRequest request) {
            if (request.isUserInRole("ADMIN")) {
                return "redirect:/admin/ogrody";
            } else if (request.isUserInRole("USER")) {
                return "redirect:/user/ogrody";
            } else {
                return "redirect:";
            }
        }
